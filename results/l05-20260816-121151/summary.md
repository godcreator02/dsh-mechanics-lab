...
跑于 2026-08-16 12:11:51（本地时间）

## 用例

### ✅ `test_insert_without_id_appends_to_root`  ·  7.41s
...
### ✅ `test_insert_with_id_targeting_non_group_warns_and_skips`  ·  0.38s
...
### ✅ `test_null_sets_key_to_null_not_delete`  ·  0.46s
...
### ✅ `test_later_patch_can_target_earlier_insert`  ·  0.47s
...
### ✅ `test_missing_id_warns_and_skips_rest_still_applies`  ·  0.43s
...
### ✅ `test_arbitrary_fields_pass_through_patch`  ·  0.39s
...
### ✅ `test_disabled_js_expression_is_evaluated[expr-false-loads]`  ·  1.89s

```
!!js false → 加载了：l05-patch-v1
```

### ✅ `test_disabled_js_expression_is_evaluated[expr-true-disabled]`  ·  13.44s
