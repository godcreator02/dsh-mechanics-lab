...
跑于 2026-08-16 13:58:01（本地时间）

## 用例

### ✅ `test_insert_without_id_appends_to_root`  ·  0.49s
...
### ✅ `test_insert_with_id_targeting_non_group_warns_and_skips`  ·  0.36s
...
### ✅ `test_missing_id_warns_and_skips_rest_still_applies`  ·  0.36s
...
### ✅ `test_disabled_js_expression_is_evaluated[expr-false-loads]`  ·  1.95s
...
### ✅ `test_duplicate_id_at_boot_is_fatal`  ·  0.91s
