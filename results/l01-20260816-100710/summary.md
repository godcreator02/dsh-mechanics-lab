...
跑于 2026-08-16 10:07:10（本地时间）

## 用例

### ✅ `test_entry_lands_in_composed_tree`  ·  0.67s
...
### ✅ `test_apply_actually_runs`  ·  3.47s

```
apply 执行于 2026-08-16T02:06:39.736Z，模块 import 于 2026-08-16T02:06:39.355Z
```
...
### ✅ `test_resolution_is_the_real_boundary[main-fallback]`  ·  3.49s
