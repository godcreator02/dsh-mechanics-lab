...
跑于 2026-08-16 16:27:05（本地时间）

## 用例

### ✅ `test_profile_minimal_files`  ·  2.09s
...
### ✅ `test_empty_bundles_boots`  ·  6.55s
...
普查员写出见证文件了吗？ True
  ...
  ── settle 快照 ──
    ...
    · id=48e9d2da                 @deepseek-ai/cordis-plugin-timer           state=2
    · id=00aa34d2                 @deepseek-ai/cordis-plugin-hmr             state=2
```

### ✅ `test_effective_config_vs_entry_tree`  ·  6.55s
...
timer 有没有被 link 进 profile？ False（预期 False）
  ...
  ── settle 快照 ──
    ...
    · id=18fcf43e                 @deepseek-ai/cordis-plugin-hmr             state=2
...
看了 15 秒。进程还活着？ True
  ...
  ── 还活着时树里有什么 ──
    ...
    · id=include                  cordis:include                             state=2
    ·     id=census                   l00-census                                 state=2  ⊂include
    · id=a415a660                 @deepseek-ai/cordis-plugin-timer           state=2
    · id=a667fd65                 @deepseek-ai/cordis-plugin-hmr             state=2
```
