...
跑于 2026-08-16 16:31:38（本地时间）

## 用例

### ✅ `test_loader_internal_activated`  ·  0.98s
...
### ✅ `test_windows_absolute_path`  ·  10.03s
...
### ✅ `test_nonexistent_bare_package`  ·  8.03s
...
### ✅ `test_relative_path_has_no_fallback_chain`  ·  10.70s
