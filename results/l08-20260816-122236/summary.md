...
── outer-group ⊃ {leaf-1, inner-group ⊃ leaf-2} ──
    ...
    · id=7cb64fab             @deepseek-ai/cordis-plugin-timer       state=2
    · id=3401ee1e             @deepseek-ai/cordis-plugin-hmr         state=2

  深度：outer-group=1  leaf-1=2  inner-group=2  leaf-2=3
  扁平列表里的出场顺序：['include', 'census', 'outer-group', 'leaf-1', 'inner-group', 'leaf-2', '7cb64fab', '3401ee1e']
...
── group 自己不受 disabled 影响，孩子却因它而停 ──
    ...
    · id=5864ac65             @deepseek-ai/cordis-plugin-timer       state=2
    · id=d5133142             @deepseek-ai/cordis-plugin-hmr         state=2
...
── 对照组：普通条目被禁用，自己就真的不激活 ──
    ...
    · id=e25145ed             @deepseek-ai/cordis-plugin-timer       state=2
    · id=0ab1dfe4             @deepseek-ai/cordis-plugin-hmr         state=2
...
── group-a{flavor-a, taster-a} / group-b{flavor-b, taster-b} ──
    ...
    · id=987a2c3d             @deepseek-ai/cordis-plugin-timer       state=2
    · id=068c5b6e             @deepseek-ai/cordis-plugin-hmr         state=2

  group-a 的 taster 看到：{'marker': 'lab-flavor-taster-v1', 'appliedAt': '2026-08-16T04:22:33.158Z', 'sawValue': 'vanilla', 'sawProviderMarker': 'lab-flavor-v1'}
  group-b 的 taster 看到：{'marker': 'lab-flavor-taster-v1', 'appliedAt': '2026-08-16T04:22:33.158Z', 'sawValue': 'chocolate', 'sawProviderMarker': 'lab-flavor-v1'}
