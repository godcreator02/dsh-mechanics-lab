...
跑于 2026-08-16 10:54:56（本地时间）

## 用例

### ✅ `test_entry_lands_in_composed_tree`  ·  0.59s
...
### ✅ `test_apply_actually_runs`  ·  3.18s

```
apply 执行于 2026-08-16T02:54:26.862Z，模块 import 于 2026-08-16T02:54:26.501Z
```

### ✅ `test_id_and_name_are_different_things`  ·  3.49s

```
id 与包名完全不同，插件照常加载 —— id 只是树内地址
```

### ✅ `test_config_reaches_apply`  ·  3.12s

```
apply 收到的 config：{'witness': 'D:/dshfiles/26081520anu/dsh-mechanics-lab/.testhome/l01/witness-config.json', '口令': '洛阳纸贵', '数字': 42, '开关': True}
```

### ✅ `test_resolution_is_the_real_boundary[exports]`  ·  3.10s

```
[exports 指向入口] → 加载了（符合预期）
```

### ✅ `test_resolution_is_the_real_boundary[index-fallback]`  ·  3.14s
...
### ✅ `test_resolution_is_the_real_boundary[main-fallback]`  ·  3.21s
