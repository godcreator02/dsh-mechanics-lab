...
跑于 2026-08-16 03:40:14（本地时间）

## 用例

### ✅ `test_entry_lands_in_composed_tree`  ·  0.52s
...
### ✅ `test_apply_actually_runs`  ·  3.04s

```
apply 执行于 2026-08-15T19:39:46.571Z，模块 import 于 2026-08-15T19:39:46.239Z
```

### ✅ `test_id_and_name_are_different_things`  ·  3.13s

```
id 与包名完全不同，插件照常加载 —— id 只是树内地址
```

### ✅ `test_config_reaches_apply`  ·  2.76s

```
apply 收到的 config：{'witness': 'D:/dshfiles/26081520anu/dsh-mechanics-lab/.testhome/l01/witness-config.json', '口令': '洛阳纸贵', '数字': 42, '开关': True}
```

### ✅ `test_resolution_is_the_real_boundary[exports]`  ·  2.77s
...
### ✅ `test_resolution_is_the_real_boundary[main-fallback]`  ·  3.08s
