...
### ✅ `test_empty_bundles_boots`  ·  6.45s
...
普查员写出见证文件了吗？ True
  ...
  ── settle 快照 ──
    ...
    · id=dfc2608d                     @deepseek-ai/cordis-plugin-timer           state=2
    · id=d09ef7b6                     @deepseek-ai/cordis-plugin-hmr             state=2
```

### ✅ `test_ghost_entries`  ·  6.45s
...
配方里的条目（1 个）：['l00-census']
  ...
  ── settle：boot() 返回之后 ──
    ...
    · id=include                      cordis:include                             state=2
    · id=census                       l00-census                                 state=2
    · id=3125b9ef                     @deepseek-ai/cordis-plugin-timer           state=2
    · id=6d6ab6a5                     @deepseek-ai/cordis-plugin-hmr             state=2

  幽灵条目（树里有、配方里没有）：['@deepseek-ai/cordis-plugin-hmr', '@deepseek-ai/cordis-plugin-timer', 'cordis:include']
  boot 之后新增的条目 id：['3125b9ef', '6d6ab6a5']
```
...
timer 有没有被 link 进 profile？ False（预期 False）
  ...
  ── settle 快照 ──
    ...
    · id=c965c079                     @deepseek-ai/cordis-plugin-hmr             state=2
...
看了 15 秒。进程还活着？ True
  ...
  ── 还活着时树里有什么 ──
    ...
    · id=include                      cordis:include                             state=2
    · id=census                       l00-census                                 state=2
    · id=ee144057                     @deepseek-ai/cordis-plugin-timer           state=2
    · id=94f252a2                     @deepseek-ai/cordis-plugin-hmr             state=2
```
...
── 基线 · 默认（兜底） ──
    ...
    · id=include                      cordis:include                             state=2
    · id=census                       l00-census                                 state=2
    · id=6633e6e8                     @deepseek-ai/cordis-plugin-timer           state=2
    · id=5958ca7d                     @deepseek-ai/cordis-plugin-hmr             state=2
    hmr 条目：['5958ca7d']
