...
跑于 2026-08-16 16:33:27（本地时间）

## 用例

### ✅ `test_bundle_patch_and_bundles_list_are_cold`  ·  38.21s

```
初次响应：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:32:25.689Z', 'appliedAt': '2026-08-16T08:32:26.415Z', 'configRevision': 'r1'}
改完 patch 之后，静态 --dump-config 已经算出新值：'r2'
运行中实例的响应（bundle patch 已经改了）：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:32:25.689Z', 'appliedAt': '2026-08-16T08:32:26.415Z', 'configRevision': 'r1'}
重启后的响应：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:32:42.913Z', 'appliedAt': '2026-08-16T08:32:43.482Z', 'configRevision': 'r2'}
摘掉 bundles 名单后、运行中实例的响应：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:32:42.913Z', 'appliedAt': '2026-08-16T08:32:43.482Z', 'configRevision': 'r2'}
重启后（bundles 名单已经不含探针包）：None
```

### ✅ `test_two_registration_paths_are_independent`  ·  6.30s

```
活层 insert、包不在 bundles 名单里：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:33:05.365Z', 'appliedAt': '2026-08-16T08:33:05.920Z', 'configRevision': 'live-insert'}
重启后：{'marker': 'l06-probe-bundle-v1', 'moduleLoadedAt': '2026-08-16T08:33:09.008Z', 'appliedAt': '2026-08-16T08:33:09.634Z', 'configRevision': 'live-insert'}
```

### ✅ `test_duplicate_id_across_bundle_and_live_layer_kills_boot`  ·  15.06s
